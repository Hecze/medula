  ...
  return (
    <section id="about" className="pt-16 md:pt-12 lg:pt-14">
      <div className="container">
        <div className="border-b border-body-color/[.15] pb-2 dark:border-white/[.15] md:pb-20 lg:pb-28">
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              <FadeInSection animationClass="animate-fade-in-down-10" threshold={0.3}>
                ...
                <div className="mb-12 max-w-[570px] lg:mb-0" data-wow-delay=".15s">
                  ...
                  <p className="mb-5 text-lg font-medium text-body-color">
                  Lo que hace a Medula especial es nuestro pensamiento lateral y disruptivo. Reclutamos constantemente jóvenes talentos de distintas universidades y concursos, invirtiendo en su formación y desarrollo. Gracias a este enfoque, hemos reunido a las mentes más brillantes de Latinoamérica. Lo que nos permite ofrecer soluciones innovadoras y frescas.                   </p>
                </div>
              </FadeInSection>
